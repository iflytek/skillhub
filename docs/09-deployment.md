...
- 如果要启用密码重置验证码邮件，补充 `SPRING_MAIL_*` 与 `SKILLHUB_AUTH_PASSWORD_RESET_*` 配置；详细运行说明见 `../design/runtime/password-reset-email-smtp.md`
...
- `../design/runtime/security-scanning-runtime.md`
