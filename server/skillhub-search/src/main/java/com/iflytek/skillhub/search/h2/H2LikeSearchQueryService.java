...
public class H2LikeSearchQueryService implements SearchQueryService {

    private final EntityManager entityManager;

    public H2LikeSearchQueryService(EntityManager entityManager) {
    ...
    public SearchResult search(SearchQuery query) {
        ...
        bindSharedParameters(resultQuery, query, memberNamespaceIds, normalizedKeyword, useRelevanceOrdering);
    ...
    private void bindSharedParameters(Query query,
